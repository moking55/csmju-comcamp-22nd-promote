		...
		<div class="flex justify-between">
			...
			<div class="flex justify-between">
				<div class="flex items-end flex-col gap-2">
					...
					<div
						class="tooltip"
						data-tip="ทำการแจ้งเตือน ผู้เข้าร่วมที่ทำการส่งหลักฐานล่าช้ามากกว่า 5 วันนับตั้งแต่ตอนสร้างบัญชี โดยข้อความแจ้งเตือนจะถูกส่งใน กล่องข้อความ และ อีเมล์ที่ติดต่อของผู้ใช้"
					>
